...
o~wyczerpanym stanie magazynowym mają zablokowaną możliwość dodania do koszyka. 

\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{ProductView.png}
    \caption{Widok katalogu produktów zrealizowanego serwisu.}
    \label{fig:product-view}
\end{figure}

\textbf{Koszyk} (\code{CartView}) umożliwia edycję ilości i~usuwanie pozycji,

\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{CartView.png}
    \caption{Widok koszyka zrealizowanego serwisu.}
    \label{fig:cart-view}
\end{figure}

\textbf{Finalizacja} (\code{CheckoutView}) zbiera adres dostawy i~składa zamówienie. 

\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{CheckoutView.png}
    \caption{Widok finalizacji zamówienia zrealizowanego serwisu.}
    \label{fig:checkout-view}
\end{figure}

Po jego utworzeniu użytkownik przechodzi do \textbf{szczegółów zamówienia} (\code{OrderDetailsView}).
Prezentujących pozycje, adres, bieżący status wraz z~wizualizacją postępu w~cyklu życia. 

\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{OrderDetailsView.png}
    \caption{Widok szczegółów zamówienia zrealizowanego serwisu.}
...
\begin{figure}[H]
    ...
    \caption{Widok płatności zrealizowanego serwisu.}
    \label{fig:payment-view}
\end{figure}

Historię zamówień prezentuje \code{OrdersView},

\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{OrderHistory.png}
    \caption{Widok historii zamówień zrealizowanego serwisu.}
    \label{fig:order-history-view}
\end{figure}

\textbf{Pulpit} (\code{DashboardView}) pokzuje podsumowanie. Czyli liczbę aktywnych zamówień
i~ostatnią płatność. 

\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{DashboardView.png}
    \caption{Widok pulpitu zrealizowanego serwisu.}
    \label{fig:dashboard-view}
\end{figure}

Całość spina powłoka aplikacji ze~stałym panelem nawigacyjnym.

\begin{figure}[H]
    \centering
    \includegraphics[scale=0.6]{NavigationPanel.png}
    \caption{Widok paneluj nawigacyjnego zrealizowanego serwisu.}
...
\begin{figure}[H]
    ...
    \caption{Widok strony przekierowującej do logowania.}
    \label{fig:home-view}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Widok logowania Cognito.}
