...
przedstawiono na~rysunku~\ref{fig:order-details-view} --- pasek postępu odzwierciedla kolejne stany maszyny
stanów zamówienia opisanej w~sekcji~\ref{sec:order-service}.
...
\begin{figure}[H]
    ...
    \caption{Widok paneluj nawigacyjnego zrealizowanego serwisu. (źródło: opracowanie własne)}
