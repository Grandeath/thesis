...
o~ograniczonej złożoności \parencite{newman2021}.
...
może unieruchomić aplikację w~całości \parencite{richardson2018}.
...
i~wdrażane niezależnie w~sposób w~pełni zautomatyzowany \parencite{fowler2014}. Zestawienie najważniejszych różnic
...
Literatura przedmiotu \parencite{newman2021,richardson2018} wskazuje zestaw cech konstytuujących architekturę
...
(\emph{bounded contexts}) w~rozumieniu projektowania sterowanego domeną (\emph{Domain-Driven Design}) \parencite{evans2003}.
...
które w~praktyce odbiera usługom niezależność wdrożeniową \parencite{newman2021}.
...
kaskadowych, w~których problem jednej usługi unieruchamia kolejne \parencite{richardson2018}. Powoduje to złamanie paradygmatu
...
odbiorców. Powoduje to łatwe dodawanie kolejnych subskrybentów bez zmian po stronie producenta \parencite{kleppmann2017}.
...
sam komunikat może zostać doręczony wielokrotnie. Konsumenci muszą zatem przetwarzać komunikaty w~sposób idempotentny \parencite{kleppmann2017}.
...
projektowych) \parencite{richardson2018}. Poniżej omówiono wzorce, które znalazły bezpośrednie zastosowanie
...
Dzięki czemu ten sam artefakt może być wdrażany w~różnych środowiskach bez rekompilacji \parencite{twelvefactor}.
...
uruchamiają się w~ułamkach sekund i~wprowadzają znikomy narzut wydajnościowy \parencite{burns2022}.
