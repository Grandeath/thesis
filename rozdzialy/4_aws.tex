...
wysokiej dostępności. Awaria pojedynczej strefy nie przerywa działania systemu \parencite{awsdocs}.
...
i~uprawnień, ochronę danych oraz poprawność własnych aplikacji \parencite{awsdocs}.
...
zarządzana przez AWS. Użytkownik widzi tylko punkt końcowy API \parencite{awsdocs}. Użytkownik odpowiada
